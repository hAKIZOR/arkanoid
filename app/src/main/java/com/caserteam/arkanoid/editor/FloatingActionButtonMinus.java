...
public class FloatingActionButtonMinus extends View{
    ...
    FloatingActionButtonMinusListener floatingActionButtonMinusListener;
    Context context;
    Paint mButtonPaint;
    ...
    public FloatingActionButtonMinus(Context context) {
        super(context);
        this.context = context;
        init(Color.WHITE);
        floatingActionButtonMinusListener =(FloatingActionButtonMinusListener) context;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            setAlpha(0.6f);
            floatingActionButtonMinusListener.onFloatingActionButtonMinusClicked();
        }
    ...
    public interface FloatingActionButtonMinusListener{
        void onFloatingActionButtonMinusClicked();
    }
    public static class Builder {
        ...
        public FloatingActionButtonMinus create() {
            final FloatingActionButtonMinus button = new FloatingActionButtonMinus(activity);
