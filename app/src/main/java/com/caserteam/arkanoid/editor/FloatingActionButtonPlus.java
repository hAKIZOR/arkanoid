...
public class FloatingActionButtonPlus extends View{
    ...
    FloatingActionButtonPlusListener floatingActionButtonPlusListener;
    Context context;
    Paint mButtonPaint;
    ...
    public FloatingActionButtonPlus(Context context) {
        ...
        init(Color.WHITE);
        floatingActionButtonPlusListener =(FloatingActionButtonPlusListener) context;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            setAlpha(0.6f);
            floatingActionButtonPlusListener.onFloatingActionButtonPlusClicked();
        }
    ...
    public interface FloatingActionButtonPlusListener{
        void onFloatingActionButtonPlusClicked();
    }
    public static class Builder {
        ...
        public FloatingActionButtonPlus create() {
            final FloatingActionButtonPlus button = new FloatingActionButtonPlus(activity);
